...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildQuickActionCard(
                      ...
                      label: 'New Folder',
                      onTap: () => Navigator.pushNamed(context, '/create-folder'),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => Navigator.pushNamed(context, '/pdfs-list'),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        onTap: () => Navigator.pushNamed(context, '/view-single-pdf'),
                      ),
                    );
                  },
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => Navigator.pushNamed(context, '/folder-list-view'),
                      child: const Text('See All'),
                    ),
                  ],
                ),
    ...
    onPressed: () {
    Navigator.pushNamed(context, '/folder-list-view');
    },
    ),
